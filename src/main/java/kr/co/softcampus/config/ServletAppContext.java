...
import kr.co.softcampus.Intercepter.CheckLoginInterceptor;
import kr.co.softcampus.Intercepter.CheckWriterInterceptor;
import kr.co.softcampus.Intercepter.TopMenuInterceptor;
import kr.co.softcampus.bean.UserBean;
...
public class ServletAppContext implements WebMvcConfigurer{
	...
	// Controller의 메소드가 반환하는 jsp의 이름 앞뒤에 경로와 확장자를 붙혀주도록 설정
	@Override
